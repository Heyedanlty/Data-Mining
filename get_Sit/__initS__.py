...
if __name__ == '__main__':
    ...
    filepath1 = 'C:/6/dataall/current_data/n29.csv'
    n29data = np.loadtxt(filepath1, delimiter=',')

    filepath2 = 'C:/new/class_list.txt'
    classdata = np.loadtxt(filepath2, delimiter= ',')

    filepath3 = 'C:/new/prior_poison_matrix.txt'
    p1data = np.loadtxt(filepath3, delimiter=' ')

    filepath4 = 'C:/new/current_poison_matrix.txt'
    ...
    np.savetxt('C:/6/finalresultfinal.txt', result, delimiter=',', fmt='%d')
